        ...
        <div class="container">
            ...
            <div class="instructions-section">
                ...
                <dl>
                    ...
                    <dt>Add recipient</dt>
                    <dd>Your starting point, is to add a recipient or more! Click on Recipients in the menu. When viewing your list of recipients (or the lack thereof), you can click the button with the plus sign to add a new person.</dd>
